...
$ORTHER = _SCN_CreateRadioEx(1,"Ngôn ngữ khác",160,150,180,30)
GUICtrlSetOnEvent($ORTHER,_RadioCheck)

$SELECTORTHERLANGUAGE = GUICtrlCreateCombo("",340,154,150,30)
...
Func _Start()
	...
	If $FilePath = '' Then
		...
		_SCN_MsgBox(16,'Chú ý!!!',"Bạn chưa chọn tập tin ảnh nào để OCR, vui lòng chọn",500,10,$Main)
		_GUIDisable($Main)
		Return 1
	EndIf
	...
	Else
		_GUIDisable($Main, 0, 30)
		_SCN_MsgBox(16,'Chú ý!!!',"Bạn chưa chọn ngôn ngữ để OCR, vui lòng chọn lại",500,10,$Main)
		_GUIDisable($Main)
		Return 1
	EndIf
